...
- **持ち物を提案する** — 宿の設備と行き先・季節から持ち物を提案する (乾燥機あり→着替えは少なめ、プール/海→水着、秋→紅葉の支度、夏→日避け)。
- **プランを自動で決める** — 交通手段を軸に、移動時間と滞在時間が 1 日に収まる範囲で日割り案を作る。
...
apps/
  server/        Hono + (SQLite 既定 / Postgres 切替) API
    src/suggest/ 荷物・季節・プランの提案 (提案は読むだけ / 採用だけが書く)
